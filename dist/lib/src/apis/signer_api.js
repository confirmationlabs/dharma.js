...
var SignerAPI = /** @class */ (function () {
     ...
     */
    SignerAPI.prototype.asDebtor = function (debtOrder, shouldAddPersonalMessagePrefix) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.signPayloadWithAddress(wrappedDebtOrder.getDebtorCommitmentHash(), debtOrder.debtor, shouldAddPersonalMessagePrefix)];
                }
            });
        });
    };
     ...
     * @return The ECDSA signature of the debt order's debtor commitment hash
     */
    SignerAPI.prototype.asCreditor = function (debtOrder, shouldAddPersonalMessagePrefix) {
        return __awaiter(this, void 0, void 0, function () {
            var wrappedDebtOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        debtOrder = _a.sent();
                        wrappedDebtOrder = new debt_order_wrapper_1.DebtOrderWrapper(debtOrder);
                        return [2 /*return*/, this.signPayloadWithAddress(wrappedDebtOrder.getCreditorCommitmentHash(), debtOrder.creditor, shouldAddPersonalMessagePrefix)];
                }
            });
        });
    };
     ...
     * @return The ECDSA signature of the debt order's debtor commitment hash
     */
    SignerAPI.prototype.asUnderwriter = function (debtOrder, shouldAddPersonalMessagePrefix) {
        return __awaiter(this, void 0, void 0, function () {
            var wrappedDebtOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        debtOrder = _a.sent();
                        wrappedDebtOrder = new debt_order_wrapper_1.DebtOrderWrapper(debtOrder);
                        return [2 /*return*/, this.signPayloadWithAddress(wrappedDebtOrder.getUnderwriterCommitmentHash(), debtOrder.underwriter, shouldAddPersonalMessagePrefix)];
                }
            });
        });
    };
