...
var TokenAPI = /** @class */ (function () {
    ...
    TokenAPI.prototype.getSupportedTokens = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var tokenRegistry, tokenSymbolListLength;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, Promise.all(Array.from(Array(tokenSymbolListLength.toNumber()).keys()).map(function (tokenIndex) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        tokenSymbolListLength = _a.sent();
                        tokenSymbolList = Array.from(Array(tokenSymbolListLength.toNumber()).keys()).map(function (i) { return tokenRegistry.tokenSymbolList.callAsync(new bignumber_1.BigNumber(i)); });
                        return [2 /*return*/, Promise.all(tokenSymbolList)];
                }
            });
        });
    };
