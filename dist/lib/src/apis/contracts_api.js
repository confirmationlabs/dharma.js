            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.config.collateralizerAddress) return [3 /*break*/, 2];
                        return [4 /*yield*/, wrappers_1.CollateralizerContract.at(this.config.collateralizerAddress, this.web3, transactionOptions)];
                    case 1:
