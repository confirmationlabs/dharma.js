...
var OrderAPI = /** @class */ (function () {
    ...
    OrderAPI.prototype.fillAsync = function (debtOrder, options) {
        return __awaiter(this, void 0, void 0, function () {
            var txOptions, debtKernel, debtOrderWrapped;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, types_1.TransactionOptions.generateTxOptions(this.web3, ORDER_FILL_GAS_MAXIMUM, options)];
                    case 1:
                        txOptions = _a.sent();
                        return [4 /*yield*/, applyNetworkDefaults(debtOrder, this.contracts)];
                    case 2:
                        debtOrder = _a.sent();
                        return [4 /*yield*/, this.assertFillableAsync(debtOrder, options)];
                    case 3:
                        _a.sent();
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, debtKernel.fillDebtOrder.sendTransactionAsync(debtOrderWrapped.getCreditor(), debtOrderWrapped.getOrderAddresses(), debtOrderWrapped.getOrderValues(), debtOrderWrapped.getOrderBytes32(), debtOrderWrapped.getSignaturesV(), debtOrderWrapped.getSignaturesR(), debtOrderWrapped.getSignaturesS(), txOptions)];
                }
            });
        });
    };
     ...
     */
    OrderAPI.prototype.assertFillableAsync = function (debtOrder, txOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.assertConsensualityInvariants(debtOrder, txOptions)];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this.assertCreditorBalanceAndAllowanceInvariantsAsync(debtOrder, tokenTransferProxy, txOptions)];
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, this.assertValidLoanTerms(debtOrder)];
                    case 5:
                        _b.sent();
                        return [2 /*return*/];
                }
     ...
     * @returns {Promise<void>}
     */
    OrderAPI.prototype.assertValidAsync = function (debtOrder) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, debtKernel, debtToken, tokenTransferProxy;
            return __generator(this, function (_b) {
                switch (_b.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        debtOrder = _a.sent();
                        debtOrderWrapped = new wrappers_1.DebtOrderWrapper(debtOrder);
                        return [4 /*yield*/, this.assert.order.debtOrderNotCancelledAsync(debtOrder, debtKernel, exports.OrderAPIErrors.ORDER_ALREADY_CANCELLED())];
                    case 4:
                        _a.sent();
                    ...
                    case 5:
                        _a.sent();
                        this.assert.order.senderAuthorizedToCancelOrder(debtOrder, txOptions, exports.OrderAPIErrors.UNAUTHORIZED_ORDER_CANCELLATION());
                        return [2 /*return*/, debtKernel.cancelDebtOrder.sendTransactionAsync(debtOrderWrapped.getOrderAddresses(), debtOrderWrapped.getOrderValues(), debtOrderWrapped.getOrderBytes32(), txOptions)];
                }
            });
        });
    };
     ...
     */
    OrderAPI.prototype.checkOrderFilledAsync = function (debtOrder, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.getIssuanceHash(debtOrder)];
                    case 3:
     ...
     */
    OrderAPI.prototype.getIssuanceHash = function (debtOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        debtOrder = _a.sent();
                        debtOrderWrapped = new wrappers_1.DebtOrderWrapper(debtOrder);
                        return [2 /*return*/, debtOrderWrapped.getIssuanceCommitmentHash()];
                }
            });
        });
    };
     ...
     */
    OrderAPI.prototype.unpackTerms = function (debtOrder) {
        return __awaiter(this, void 0, void 0, function () {
            var termsContract, termsContractParameters, adapter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        termsContract = debtOrder.termsContract, termsContractParameters = debtOrder.termsContractParameters;
     ...
     * @returns {Promise<void>}
     */
    OrderAPI.prototype.assertValidLoanTerms = function (debtOrder) {
        return __awaiter(this, void 0, void 0, function () {
            var adapter, loanOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.adapters.getAdapterByTermsContractAddress(debtOrder.termsContract)];
                    case 1:
                        adapter = _a.sent();
                        return [4 /*yield*/, adapter.fromDebtOrder(debtOrder)];
                    case 2:
                        loanOrder = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.assert.order.notExpired(debtOrder, exports.OrderAPIErrors.EXPIRED())];
                    case 1:
                        _a.sent();
    ...
    OrderAPI.prototype.assertConsensualityInvariants = function (debtOrder, txOptions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.assert.order.validDebtorSignature(debtOrder, txOptions, exports.OrderAPIErrors.INVALID_DEBTOR_SIGNATURE())];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.assert.order.validCreditorSignature(debtOrder, txOptions, exports.OrderAPIErrors.INVALID_CREDITOR_SIGNATURE())];
                    case 2:
                        _a.sent();
                        if (!(debtOrder.underwriter && debtOrder.underwriter !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.assert.order.validUnderwriterSignature(debtOrder, txOptions, exports.OrderAPIErrors.INVALID_UNDERWRITER_SIGNATURE())];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    OrderAPI.prototype.assertCreditorBalanceAndAllowanceInvariantsAsync = function (debtOrder, tokenTransferProxy, txOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var principalToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadERC20TokenAsync(debtOrder.principalToken, txOptions)];
                    case 1:
