...
exports.CollateralizerAdapterErrors = {
    ...
    COLLATERAL_AMOUNT_IS_NEGATIVE: function () { return singleLineString(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Collateral amount cannot be negative."], ["Collateral amount cannot be negative."]))); },
...
var CollateralizedSimpleInterestLoanAdapter = /** @class */ (function () {
    ...
    CollateralizedSimpleInterestLoanAdapter.prototype.toDebtOrder = function (collateralizedSimpleInterestLoanOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            collateralTokenSymbol, collateralAmount, gracePeriodInDays, principalToken, principalTokenIndex, collateralTokenIndex, collateralizedContract, debtOrder, packedParams;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        debtOrder = omit(collateralizedSimpleInterestLoanOrder, [
                        ...
                        debtOrder = __assign({}, debtOrder, { principalToken: principalToken.address, termsContract: collateralizedContract.address, termsContractParameters: packedParams });
                        return [2 /*return*/, transaction_utils_1.TransactionUtils.applyNetworkDefaults(debtOrder, this.contractsAPI)];
                }
            });
        });
    };
    ...
    CollateralizedSimpleInterestLoanAdapter.prototype.fromDebtOrder = function (debtOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this.unpackParameters(debtOrder.termsContractParameters), principalTokenIndex = _a.principalTokenIndex, collateralTokenIndex = _a.collateralTokenIndex, params = __rest(_a, ["principalTokenIndex", "collateralTokenIndex"]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.assertTokenCorrespondsToSymbol(debtOrder.principalToken, principalTokenSymbol)];
                    case 3:
                        // Assert that the principal token corresponds to the symbol we've unpacked.
                        _b.sent();
                        return [2 /*return*/, __assign({}, debtOrder, { principalTokenSymbol: principalTokenSymbol,
