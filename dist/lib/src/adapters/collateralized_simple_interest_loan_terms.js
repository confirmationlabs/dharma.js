...
var MAX_COLLATERAL_TOKEN_INDEX_HEX = terms_contract_parameters_1.TermsContractParameters.generateHexValueOfLength(2);
...
var CollateralizedLoanTerms = /** @class */ (function () {
    ...
    CollateralizedLoanTerms.prototype.assertCollateralAmountWithinBounds = function (collateralAmount) {
        ...
        if (collateralAmount.isNegative()) {
            throw new Error(collateralized_simple_interest_loan_adapter_1.CollateralizerAdapterErrors.COLLATERAL_AMOUNT_IS_NEGATIVE());
        }
