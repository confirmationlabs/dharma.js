                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, transaction_utils_1.TransactionUtils.sendRawTransaction(self.web3, self.web3ContractInstance, "safeTransferFrom", "address,address,uint256" + (_data.length > 0 ? ",bytes" : ""), _data.length > 0 ? [_from, _to, _tokenId, _data] : [_from, _to, _tokenId], txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
