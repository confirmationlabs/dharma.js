...
var debt_order_1 = require("../src/types/debt_order");
...
(function (TransactionUtils) {
    ...
    TransactionUtils.sendRawTransaction = sendRawTransaction;
    function applyNetworkDefaults(debtOrder, contracts) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        networkDefaults = __assign({}, debt_order_1.DEBT_ORDER_DEFAULTS, { kernelVersion: debtKernel.address, issuanceVersion: repaymentRouter.address });
                        return [2 /*return*/, assignDefaults(debtOrder, networkDefaults)];
                }
            });
        });
    }
    TransactionUtils.applyNetworkDefaults = applyNetworkDefaults;
})(TransactionUtils = exports.TransactionUtils || (exports.TransactionUtils = {}));
