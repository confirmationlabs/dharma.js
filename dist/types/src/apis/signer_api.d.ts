...
export declare class SignerAPI {
     ...
     */
    asDebtor(debtOrder: DebtOrder, shouldAddPersonalMessagePrefix: boolean): Promise<ECDSASignature>;
    /**
     ...
     * @return The ECDSA signature of the debt order's debtor commitment hash
     */
    asCreditor(debtOrder: DebtOrder, shouldAddPersonalMessagePrefix: boolean): Promise<ECDSASignature>;
    /**
     ...
     * @return The ECDSA signature of the debt order's debtor commitment hash
     */
    asUnderwriter(debtOrder: DebtOrder, shouldAddPersonalMessagePrefix: boolean): Promise<ECDSASignature>;
    /**
